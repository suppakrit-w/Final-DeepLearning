...
1. **เหตุผลที่จำเป็นต้องใช้ deep learning ในการแก้ปัญหา**
...
1. **จุดเด่นของ Deep Learning (CNNs) ที่ใช้ในโปรเจกต์**
**\
...
1. **จุดด้อยของ Deep Learning (CNNs) ที่ใช้ในโปรเจกต์**
