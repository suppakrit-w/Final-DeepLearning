...
#### จัดทำโดย
* 6814500949 นายศุภกฤต วัฒนศรี
* 6814500922 นายปัญจพล บานเพียร
...
| bcc | 	0.5180 | 	0.6990 | 	0.5950 | 
| bkl | 	0.5172 | 	0.6818 | 	0.5882 | 
| df | 	0.4375 | 	0.6087 | 	0.5091 | 
| mel | 	0.4416 | 	0.5426 | 	0.4869 | 
| nv | 	0.9507 | 	0.7912 | 	0.8637 | 
| vasc | 	0.6765 | 	0.8214 | 	0.7419 | 
| accuracy |  | 			 | 0.7439 | 
| macro avg | 	0.5653 | 	0.6998 | 	0.6172 | 
...
| bcc | 	0.5455 | 	0.6990 | 	0.6128 | 
| bkl | 	0.4368 | 	0.7545 | 	0.5533 | 
| df | 	0.6667 | 	0.6957 | 	0.6809 | 
| mel | 	0.4144 | 	0.5426 | 	0.4699 | 
| nv | 	0.9494 | 	0.7554 | 	0.8414 | 
| vasc | 	0.5946 | 	0.7857 | 	0.6769 | 
| accuracy |  |  | 			0.7259 | 
| macro avg | 	0.6039 | 	0.7014 | 	0.6403 | 
| weighted avg | 	0.7939 | 	0.7259 | 	0.7462 | 
...
## โมเดลที่ฝึกแล้ว (Trained Models)

เนื่องจากไฟล์โมเดล (.pth) มีขนาดใหญ่ จึงไม่ได้รวมไว้ใน Git Repository นี้ 
คุณสามารถดาวน์โหลดโมเดลที่ฝึกเสร็จแล้ว (Trained Checkpoints) ได้จากลิงก์ Google Drive ด้านล่าง:

* **Custom CNN (Baseline):** [ดาวน์โหลด (ham10000_custom_cnn.pth)](https://drive.google.com/file/d/1LxHA50EtqwWui5dgPWNT_0ixa1QkBB3U/view?usp=sharing)
* **ResNet50:** [ดาวน์โหลด (ham10000_resnet50.pth)](https://drive.google.com/file/d/1OrVuceaz5i1fF-FNqqSvHYbIg86DVgFT/view?usp=sharing)
* **EfficientNet-B0 (Winner):** [ดาวน์โหลด (ham10000_efficientnet_b0.pth)](https://drive.google.com/file/d/1IYV5ucdd8MHT_WbfNmh79pNr7YLa5cEn/view?usp=sharing)
